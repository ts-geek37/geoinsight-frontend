...
const SidebarDetails: React.FC<{ onSelectStore: (store: Store) => void }> = ({
  onSelectStore
}) => {
  const {
  ...
  if (isError)
    return <p className="p-4 text-sm text-red-500">Error loading store data.</p>
